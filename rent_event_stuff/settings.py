"""
Django settings for rent_event_stuff project.
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'rent-event-stuff-d7e439e836a0.herokuapp.com',
]
...
ROOT_URLCONF = 'rent_event_stuff.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'rent_event_stuff.context_processors.canonical_url'
            ],
            'builtins': [
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'rent-event-stuff'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'services@rent-event-stuff.com'
